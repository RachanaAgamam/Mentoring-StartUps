		...
		<div id="site_content">
			<div id="content">
				...
				<form action="VoidmainServlet" method="post" name="appform" enctype="multipart/form-data">
					...
					<input type="hidden" name="type" value="com.voidmain.pojo.Mentor">
					<input type="hidden" name="redirect" value="mentorregistration.jsp">
					...
					<div class="form_settings">
						...
						<p>
							<span>Company Name</span><input class="contact" type="text" name="company"
								value="" />
						</p>
						<p>
							<span>Experience</span><input class="contact" type="text" name="experience"
								value="" />
						</p>
						<p>
							<span>Select Field Of Working</span> <select name="fieldofworking">
								<option value="electronics">Electronics</option>
								<option value="computerscience">Computer Science</option>
							</select>
						</p>
						<p>
							<span>Select Proof:</span><input class="contact" type="file" name="proof"
								value="" />
						</p>
						<p>
